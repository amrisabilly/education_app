                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 mb-8">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-6">
                            Aljabar adalah cabang matematika yang menggunakan simbol dan huruf untuk mewakili angka dan nilai. 
                            Dalam modul ini, Anda akan belajar tentang variabel, ekspresi aljabar, dan cara menyelesaikan persamaan 
                            linier sederhana. Kami akan memulai dengan konsep dasar dan secara bertahap naik ke tingkat yang lebih kompleks.
                        </p>
                    ...
                    <div class="flex gap-4 mb-8">
                        <a href="#" class="flex-1 px-6 py-3 bg-white border-2 border-gray-300 text-gray-900 font-bold rounded-lg hover:bg-gray-50 transition text-center">
                            Pelajaran Sebelumnya
                        </a>
                        <a href="#" class="flex-1 px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition text-center">
                            Pelajaran Berikutnya
                        </a>
                    </div>
                    
                    <!-- Quiz Section -->
                    <div class="bg-gradient-to-r from-purple-50 to-purple-100 border-2 border-purple-200 rounded-2xl p-8">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900 mb-2">Siap Menguji Pemahaman?</h3>
                                <p class="text-gray-700">Ikuti kuis untuk mengetahui seberapa baik Anda memahami materi ini</p>
                            </div>
                            <a href="{{ route('student.module.quiz', ['id' => $moduleId]) }}" class="px-8 py-4 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition whitespace-nowrap">
                                Mulai Kuis
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="sticky top-24">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
                            ...
                            <div class="space-y-3 border-t pt-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-lg font-bold text-yellow-600">280</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                            ...
                            <div class="divide-y max-h-96 overflow-y-auto">
                                <!-- Lesson 1: Completed -->
                                <div class="p-4 hover:bg-gray-50 transition cursor-pointer bg-green-50 border-l-4 border-green-600">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-green-600 text-white rounded-full flex-shrink-0 text-xs font-bold">1</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 hover:bg-gray-50 transition cursor-pointer bg-green-50 border-l-4 border-green-600">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-green-600 text-white rounded-full flex-shrink-0 text-xs font-bold">2</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 hover:bg-gray-50 transition cursor-pointer bg-green-50 border-l-4 border-green-600">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-green-600 text-white rounded-full flex-shrink-0 text-xs font-bold">3</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 hover:bg-gray-50 transition cursor-pointer bg-green-50 border-l-4 border-green-600">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-green-600 text-white rounded-full flex-shrink-0 text-xs font-bold">4</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 hover:bg-gray-50 transition cursor-pointer bg-blue-50 border-l-4 border-blue-600">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-blue-600 text-white rounded-full flex-shrink-0 text-xs font-bold">5</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 opacity-50 cursor-not-allowed">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-gray-400 text-white rounded-full flex-shrink-0 text-xs font-bold">6</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 opacity-50 cursor-not-allowed">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-gray-400 text-white rounded-full flex-shrink-0 text-xs font-bold">7</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 opacity-50 cursor-not-allowed">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-gray-400 text-white rounded-full flex-shrink-0 text-xs font-bold">8</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 opacity-50 cursor-not-allowed">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-gray-400 text-white rounded-full flex-shrink-0 text-xs font-bold">9</div>
                                        <div class="flex-1">
                                ...
                                <div class="p-4 opacity-50 cursor-not-allowed">
                                    <div class="flex items-start gap-3">
                                        <div class="flex items-center justify-center w-6 h-6 bg-gray-400 text-white rounded-full flex-shrink-0 text-xs font-bold">10</div>
                                        <div class="flex-1">
    ...
    <section class="px-4 md:px-6 lg:px-8 py-12 bg-white border-t">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- PDF Slide -->
                <a href="#" class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-xl p-6 hover:shadow-lg transition text-center">
                ...
                <!-- Code Examples -->
                <a href="#" class="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg transition text-center">
                ...
                <!-- Worksheet -->
                <a href="#" class="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-6 hover:shadow-lg transition text-center">
                ...
                <!-- External Links -->
                <a href="#" class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-xl p-6 hover:shadow-lg transition text-center">
                    <svg class="w-12 h-12 text-purple-600 mx-auto mb-3" fill="currentColor" viewBox="0 0 20 20">
