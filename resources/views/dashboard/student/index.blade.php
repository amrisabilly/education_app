@extends('landing.layouts.app', [
    'title' => 'Dashboard Siswa - Berbinar',
])
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p class="text-blue-100">Level: {{ session('user')['level'] }} | Kelas: {{ session('user')['kelas'] }}</p>
                </div>
                <div class="flex gap-4">
                    <a href="#" class="px-6 py-3 bg-white text-blue-600 font-bold rounded-lg hover:bg-blue-50 transition">
                        Profil
                    </a>
                    <form action="{{ route('auth.logout') }}" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="px-6 py-3 border-2 border-white text-white font-bold rounded-lg hover:bg-blue-700 transition">
                            Logout
                        </button>
                    </form>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v2a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a2 2 0 002 2h8a2 2 0 002-2H6z" clip-rule="evenodd"/>
                            </svg>
                        </div>
                    </div>
                </div>
    ...
    <section class="px-4 md:px-6 lg:px-8 py-12 bg-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition border-l-4 
                    ...
                    <div class="p-6 pb-4 border-b border-gray-100">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            @elseif($module['status'] === 'in_progress')
                                <span class="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-bold rounded-full">Sedang Belajar</span>
                            @else
                                <span class="px-3 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded-full">Terkunci</span>
                            @endif
                        </div>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-600">{{ $module['completedLessons'] }}/{{ $module['lessons'] }} Pelajaran</span>
                                <span class="text-gray-900 font-bold">{{ $module['progress'] }}%</span>
                            </div>
                            <div class="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-full" style="width: {{ $module['progress'] }}%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 pt-4">
                        <div class="flex items-center justify-between">
                            ...
                            @if($module['status'] === 'locked')
                                <button disabled class="px-6 py-3 bg-gray-300 text-gray-600 font-bold rounded-lg cursor-not-allowed">
                                    Terkunci
                                </button>
                            @elseif($module['status'] === 'completed')
                                <a href="{{ route('student.module.show', ['id' => $module['id']]) }}" class="px-6 py-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition">
                                    Review
                                </a>
                            @else
                                <a href="{{ route('student.module.show', ['id' => $module['id']]) }}" class="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition">
                                    Lanjutkan
                                </a>
                            @endif
                        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm text-center hover:shadow-md transition">
                    <div class="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <!-- Badge: Achiever -->
                <div class="bg-white p-6 rounded-2xl shadow-sm text-center hover:shadow-md transition">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                        <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
                    </div>
                ...
                <!-- Badge: Scholar -->
                <div class="bg-white p-6 rounded-2xl shadow-sm text-center hover:shadow-md transition">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-400 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                        <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm text-center hover:shadow-md transition opacity-50">
                    <div class="w-20 h-20 bg-gradient-to-br from-gray-400 to-gray-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
