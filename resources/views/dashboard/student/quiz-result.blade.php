...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-4 md:px-6 lg:px-8 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-blue-100">Kuis selesai! Lihat hasil dan penjelasan di bawah</p>
        </div>
    </section>
    ...
    <section class="px-4 md:px-6 lg:px-8 py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto">
            <!-- Score Card -->
            <div
                class="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-3xl p-12 mb-8 shadow-lg text-center">
                    ...
                    <div class="relative w-40 h-40 flex items-center justify-center">
                        <svg class="w-40 h-40 transform -rotate-90" viewBox="0 0 160 160">
                            <circle cx="80" cy="80" r="70" fill="none" stroke="#e5e7eb"
                                stroke-width="12" />
                            <circle cx="80" cy="80" r="70" fill="none" stroke="#2563eb" stroke-width="12"
                                stroke-dasharray="329.87 461.81" stroke-linecap="round" />
                        </svg>
                        <div class="absolute text-center">
                            <p class="text-5xl font-bold text-blue-600">85</p>
                    ...
                    <div class="border-2 border-blue-200 rounded-xl p-6 bg-blue-50">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-blue-700 font-medium mt-2">Jawaban Anda: B. 8 ✓</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-2 border-blue-200 rounded-xl p-6 bg-blue-50">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-blue-700 font-medium mt-2">Jawaban Anda: C. 4 ✓</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-2 space-y-1">
                                    <p class="text-blue-700 font-medium">Jawaban Anda: A. 5x - 5 ✗</p>
                                    <p class="text-blue-700 font-medium">Jawaban Benar: D. 5x - 5</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-2 border-blue-200 rounded-xl p-6 bg-blue-50">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-blue-700 font-medium mt-2">Jawaban Anda: C. 2x² + x - 3 ✓</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-2 border-blue-200 rounded-xl p-6 bg-blue-50">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-blue-700 font-medium mt-2">Jawaban Anda: B. (x + 2)(x + 3) ✓</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a href="/dashboard/student"
                        class="px-6 py-3 bg-white border-2 border-gray-300 text-gray-900 font-bold rounded-lg hover:bg-gray-50 transition text-center">
                        Kembali ke Dashboard
                    </a>
                    <a href="/dashboard/student/module/2"
                        class="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition text-center">
                        Lanjutkan Modul
                    </a>
                    <a href="#"
                        class="px-6 py-3 border-2 border-blue-600 text-blue-600 font-bold rounded-lg hover:bg-blue-50 transition text-center">
                        Ulangi Kuis
                    </a>
                </div>
            </div>
